...
from sectorcomparison import SectorComparisonWidget  # Import SectorComparisonWidget
from focus import FocusView
from sentanalysis import SentimentAnalysis  # Import SentimentAnalysis
...
class SettingsDialog(QDialog):
    def __init__(self, parent=None):
        ...
        apply_combobox_style(self.theme_combobox)  # Apply combobox style here
...
class SentimentAnalysisWidget(QWidget):
    def __init__(self, parent):
        ...
        self.graph_view = QWebEngineView(self)  # Use QWebEngineView to display Plotly graph
...
class App(QWidget):
    ...
    def initUI(self):
        ...
        self.buttons = {}  # Dictionary to store buttons and their corresponding widgets

        self.focus_view = FocusView(self)
        self.stock_comparison = StockComparisonWidget(self)  # Use StockComparisonWidget directly
        self.sector_comparison = SectorComparisonWidget(self)  # Add SectorComparisonWidget
        ...
        self.opportunity_finder = QWidget()  # Add OpportunityFinder Widget
        ...
        self.sentiment_analysis = SentimentAnalysisWidget(self)  # Add Sentiment Analysis Widget
        ...
        self.stack.addWidget(self.opportunity_finder)  # Added new widget
        self.stack.addWidget(self.sentiment_analysis)  # Added new widget
        self.stack.addWidget(self.settings)

        self.setLayout(layout)
        self.apply_styles()
        self.display_focus_view()  # Display the initial tab
    ...
    def on_sidebar_button_click(self, callback, button):
        # Set stylesheet of all buttons to default
        for btn in self.buttons:
            btn.setStyleSheet("")

        # Set stylesheet of the active button
    ...
    def display_stock_comparison(self):
        ...
        # Perform the initial comparison when the widget is shown
